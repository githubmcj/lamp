...
public class WYACustomDialog extends Dialog {
    ...
    private NoClickListener noOnclickListener;//取消按钮被点击了的监听器
    private YesClickListener yesOnclickListener;//确定按钮被点击了的监听器
     ...
     */
    public void setNoClickListener(NoClickListener onNoOnclickListener) {
     ...
     */
    public void setYesClickListener(YesClickListener onYesOnclickListener) {
    ...
    public static final class Builder {
        ...
        public Builder confirmText(String confirmTextStr) {
            this.confirmTextStr = confirmTextStr;
            return this;
        }
        
        public Builder cancelText(String cancelTextStr) {
