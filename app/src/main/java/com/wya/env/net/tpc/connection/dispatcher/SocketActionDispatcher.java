package com.wya.env.net.tpc.connection.dispatcher;

import com.wya.env.net.tpc.connection.dispatcher.MainThreadExecutor;
...
import static com.wya.env.net.tpc.connection.action.IOAction.ACTION_READ_COMPLETE;
import static com.wya.env.net.tpc.connection.action.SocketAction.ACTION_CONN_FAIL;
import static com.wya.env.net.tpc.connection.action.SocketAction.ACTION_CONN_SUCCESS;
import static com.wya.env.net.tpc.connection.action.SocketAction.ACTION_DISCONNECTION;
