...
import   com.wya.env.net.tpc.config.SocketFactory;
import   com.wya.env.net.tpc.config.SocketSSLConfig;
import   com.wya.env.net.tpc.connection.reconnect.AbsReconnection;
import   com.wya.env.net.tpc.connection.reconnect.DefaultReConnection;
import   com.wya.env.net.tpc.entity.SocketAddress;
import   com.wya.env.net.tpc.interfaces.io.IMessageProtocol;
...
public class EasySocketOptions {
    ...
    public static class Builder {
        ...
        public   com.wya.env.net.tpc.config.EasySocketOptions build() {
    ...
    public static void setIsDebug(boolean isDebug) {
          com.wya.env.net.tpc.config.EasySocketOptions.isDebug = isDebug;
    }
