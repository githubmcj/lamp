...
import com.wya.env.net.tpc.entity.exception.RequestCancelException;
import com.wya.env.net.tpc.interfaces.callback.IProgressDialog;
import com.wya.env.net.tpc.interfaces.callback.ProgressCancelListener;
        ...
        if (isCancel) {
            mDialog.setOnCancelListener(new DialogInterface.OnCancelListener() {
                ...
                public void onCancel(DialogInterface dialogInterface) {
                    com.wya.env.net.tpc.callback.ProgressDialogCallBack.this.onCancelProgress();
                }
            });
        }
    }
